...
const tech = () => {
  const data = [
    ...
    },
    {
      ...
      id: 3,
      main: "/icons/c++.svg",
      desc: "A high-performance, general-purpose programming language used for system software, game development, and applications requiring close-to-hardware control.",
      tag: "code",
      bg: "bg-blue-50",
      text: "text-blue-500",
    },
    ...
    },
    {
      ...
      desc: "A minimal and flexible Node.js web application framework that simplifies building web servers and APIs.",
      tag: "develop",
      bg: "bg-gray-900",
      text: "text-gray-50",
    },
    {
      title: "Node JS",
      id: 7,
      main: "/icons/nodejs.svg",
      desc: "A JavaScript runtime that allows developers to build scalable server-side applications using asynchronous, event-driven programming.",
      tag: "develop",
      bg: "bg-green-100",
      text: "text-green-500",
    },
    {
      ...
      desc: "A lightweight Python web framework that provides the essentials for building simple, extensible web applications with minimal setup.",
      tag: "develop",
      bg: "bg-gray-900",
      text: "text-gray-50",
    },
    {
      title: "Firebase",
      id: 9,
      main: "/icons/firebase.svg",
      desc: "A platform developed by Google for building mobile and web applications, offering services like real-time databases, authentication, and hosting.",
      tag: "database",
      bg: "bg-yellow-100",
      text: "text-yellow-500",
    },
    {
      title: "Supabase",
      id: 10,
      main: "/icons/supabase.svg",
      desc: "An open-source Firebase alternative providing a backend-as-a-service with features like real-time data, authentication, and storage on top of PostgreSQL.",
      tag: "database",
      bg: "bg-green-100",
      text: "text-green-500",
    },
    {
      ...
      desc: "A NoSQL database that stores data in flexible, JSON-like documents, designed for scalability and high availability.",
      tag: "database",
      bg: "bg-green-100",
      text: "text-green-500",
    },
    {
      title: "MySQL",
      id: 12,
      main: "/icons/mysql.svg",
      desc: "A widely-used open-source relational database management system known for its reliability, performance, and ease of use in web applications.",
      tag: "database",
      bg: "bg-blue-100",
      text: "text-blue-500",
    },
