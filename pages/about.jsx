        ...
        <div className=" mx-auto pt-16 -pb-10 max-w-7xl">
          ...
          <div className=" text-[0.92rem] text-base mx-12 font-light dark:text-white text-gray-900">
            <p className="mt-6 mb-12 font-normal">
              ...
              Experience in React.js, Next.js, ExpressJS, Node.js, Flask 
              with proficiency in web technologies like JavaScript,
            ...
            <p className="">
              ...
              <a
                onClick={() =>
                  navigator.clipboard.writeText("ashketchem4663@gmai.com")
                }
                ...
                href="mailto:ashketchem4663@gmail.com"
              >
                {" "}
              ...
              <a
                href="https://www.linkedin.com/in/ashish-lohia-88671a201/"
              ...
              <a
                href="https://www.instagram.com/ash_ish_l/"
                target="blank"
                rel="noopener noreferrer"
