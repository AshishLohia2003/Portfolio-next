  ...
  const data = [
    {
      ...
      org: "Quickgick",
      link: "https://www.linkedin.com/company/quick-gick/posts/?feedView=all",
      skills: ["React.js", "Redux.js", "Firebase", "Nodejs", "Expressjs", "Flask", "MUI"],
      class:
        "bg-red-100 text-red-800 text-sm font-medium me-2 px-2.5 py-0.5 mb-2 rounded dark:bg-red-900 dark:text-red-300",
    },
    {
      id: 1,
      ...
      org: "Made2Automate",
      link: "https://www.linkedin.com/company/made-2-automate/posts/?feedView=all",
      skills: ["React.js", "Node.js", "Express.js", "Firebase", "Supabase"],
      class:
        "bg-green-100 text-green-800 text-sm font-medium me-2 px-2.5 py-0.5 mb-2 rounded dark:bg-green-900 dark:text-green-300",
    },
    // {
    //   id: 2,
      ...
      <ol className="relative border-s border-gray-200 dark:border-gray-700">
        {data.map((item) => (
          <li className="mb-10 ms-6" key={item.id}>
            ...
            <a href={item.link} target="blank" >{item.org}</a>
