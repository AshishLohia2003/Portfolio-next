...
import ashish_header_black from "@/public/logo_text_black.png";
import ashish_header_white from "@/public/logo_text_white.png";
    ...
    >
      <div className="flex justify-between md:space-x-10 lg:space-x-12 xl:space-x-16 md:flex items-center place-items-center md:justify-center py-3 md:px-10 px-8">
        <div className="select-none order-2 md:order-1 cursor-pointer flex items-center text-gray-800">
          <Link href={"/"} className="">
            {currentTheme === "dark" ? (
              <Image src={ashish_header_white} alt="header" width="100" />
            ) : (
              <Image src={ashish_header_black} alt="header" width="100" />
            )}
          </Link>
        </div>
        {currentTheme === "dark" ? (
